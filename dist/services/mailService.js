...
exports.logEmailError = exports.sendSalesEmail = exports.sendBusinessInquiry = exports.sendSupportResponse = exports.sendAdminNotification = exports.sendOTPEmail = exports.sendJobNotificationEmail = exports.sendRegistrationEmail = exports.sendEmail = exports.verifyEmailConnection = exports.EMAIL_CONTEXTS = exports.EMAIL_ADDRESSES = void 0;
...
exports.EMAIL_CONTEXTS = {
    REGISTRATION: exports.EMAIL_ADDRESSES.CAREERS,
    JOB_NOTIFICATIONS: exports.EMAIL_ADDRESSES.NOREPLY, // send job alerts from noreply by default
    OTP: exports.EMAIL_ADDRESSES.NOREPLY, // OTPs / system notifications should come from noreply
    ADMIN_NOTIFICATIONS: exports.EMAIL_ADDRESSES.ADMIN,
    BUSINESS_INQUIRIES: exports.EMAIL_ADDRESSES.BUSINESS,
    SALES: exports.EMAIL_ADDRESSES.SALES,
    SUPPORT: exports.EMAIL_ADDRESSES.SUPPORT,
    GENERAL: exports.EMAIL_ADDRESSES.INFO,
};
// Create transporter
...
const sendEmail = async (to, subject, content, fromEmail = exports.EMAIL_ADDRESSES.NOREPLY, isHTML = true) => {
    try {
        const mailOptions = {
        ...
        if (process.env.LOG_EMAIL_ERRORS_TO_FILE === 'true') {
            try {
                ...
                const filePath = path_1.default.join(logDir, 'email-errors.log');
...
const sendRegistrationEmail = async (userEmail, userName, userRole) => {
    ...
    <p>If you have any questions, contact our support team at <a href="mailto:${exports.EMAIL_ADDRESSES.SUPPORT}">${exports.EMAIL_ADDRESSES.SUPPORT}</a>.</p>
    <p>Best regards,<br>The MCB Jobs Team</p>
  `;
    return await (0, exports.sendEmail)(userEmail, subject, content, exports.EMAIL_CONTEXTS.REGISTRATION);
};
exports.sendRegistrationEmail = sendRegistrationEmail;
// New job posting notification email
const sendJobNotificationEmail = async (userEmails, jobData) => {
  ...
  `;
    return await (0, exports.sendEmail)(userEmails, subject, content, exports.EMAIL_CONTEXTS.JOB_NOTIFICATIONS);
};
...
const sendOTPEmail = async (email, otp) => {
    ...
    <p>Best regards,<br>The MyCareerBuild Team</p>
  `;
    return await (0, exports.sendEmail)(email, subject, content, exports.EMAIL_CONTEXTS.OTP);
};
exports.sendOTPEmail = sendOTPEmail;
// Admin notification email
const sendAdminNotification = async (subject, content, adminEmails = ['admin@mycareerbuild.com']) => {
    return await (0, exports.sendEmail)(adminEmails, subject, content, exports.EMAIL_CONTEXTS.ADMIN_NOTIFICATIONS);
};
exports.sendAdminNotification = sendAdminNotification;
// Support response email
const sendSupportResponse = async (userEmail, userName, ticketId, response) => {
  ...
  `;
    return await (0, exports.sendEmail)(userEmail, subject, content, exports.EMAIL_CONTEXTS.SUPPORT);
};
exports.sendSupportResponse = sendSupportResponse;
// Business inquiry email
const sendBusinessInquiry = async (to, subject, content) => {
    return await (0, exports.sendEmail)(to, subject, content, exports.EMAIL_CONTEXTS.BUSINESS_INQUIRIES);
};
exports.sendBusinessInquiry = sendBusinessInquiry;
// Sales email
const sendSalesEmail = async (to, subject, content) => {
    return await (0, exports.sendEmail)(to, subject, content, exports.EMAIL_CONTEXTS.SALES);
};
exports.sendSalesEmail = sendSalesEmail;
// Error logging utility
const logEmailError = (context, error, recipient) => {
...
exports.logEmailError = logEmailError;
